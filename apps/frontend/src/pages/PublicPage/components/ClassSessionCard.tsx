...
import { ChevronIcon, PeopleIcon } from "../../../assets/icons";
...
export function ClassSessionCard({ session }: Props) {
              ...
              {session.isLocked && (
                <div className="rounded-lg border border-amber-300 bg-amber-50 p-3 text-xs text-amber-800">
                  <p className="mb-2 font-medium">
                    ...
                    você não poderá mais cancelar e se compromete a
                    participar, mediante pagamento, mesmo em caso de
                    ausência.
                  </p>
